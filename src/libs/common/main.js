...
function load(element, url, constructor) {
	console.log("Main.LOAD", element, url, constructor);
...
// GM - Aggiunta per rinominarla.
function loadForOmnis(element, url, constructor) {
	return load(element, url, constructor);
}
